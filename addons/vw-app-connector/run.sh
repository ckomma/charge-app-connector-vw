...
export BACKGROUND_TRANSIENT_BACKOFF_MAX_SECONDS="$(opt background_transient_backoff_max_seconds "7200")"
export SOURCE_STALE_AFTER_MINUTES="$(opt source_stale_after_minutes "60")"
...
export VERIFIED_APP_VERSION="$(opt verified_app_version "4.1.1")"
